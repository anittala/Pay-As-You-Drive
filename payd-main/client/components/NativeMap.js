...
const NativeMap = ({ route, navigation }) => {
  ...
  const callToFlask = () => {
    setIsStop(true)
    setIsLoading(false)
    axios.get(`${url}/tripOver/${userId}/${tripId}`)
    .then(res => { 
  ...
  useEffect(() => {initializeTrip(setTripId)}, [])
    ...
    function renderHeaderSection() {
      return (
          ...
          >
                      ...
                      {/* <Button title="Stop Trip" onPress={callToFlask} /> */}
                      {/* <Button title="Change Destination" onPress={() => navigation.navigate('StartJourney', destination)}/> */}
                      ...
                      >
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => navigation.navigate('StartJourney', destination)}  >
                              <Text
                              style={{
                                  color: COLORS.white,
                                  ...FONTS.h2,
